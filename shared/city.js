...
function buildCity() {
  ...
  const buildings = [], recs = [], pieces = [], solids = [];
  const put = (k, x, y, z, sx, sy, sz, rx) => { pieces.push([k, x, y, z, sx, sy, sz, rx || 0]); };
...
module.exports = { N, PITCH, RW, SWW, HALF, FH, WGRID_H, WGRID_V, ACC_MAX, SEED, BTYPE, GLASS, mulberry32, buildCity, rayAabb, aabbTouch, rayCity };
